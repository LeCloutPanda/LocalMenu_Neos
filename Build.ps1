...
$NeosProc = Start-Process -FilePath $NeosExe -WorkingDirectory $NeosDir -ArgumentList "-Screen", "-SkipIntroTutorial", "-LoadAssembly `"D:\Games\Neos\app\Libraries\NeosModLoader.dll`"" -passthru
